...
def register_views(app):
    ...
    def group_members(group_id=None):
        ...
        if group_obj:
            ...
            return jsonify({'status': "success", "type": "persons",
                            "count": len(_group_obj['persons']),
                            "data": json.loads(dumps(_group_obj))})
    ...
    def person_groups(person_id):
        ...
        return jsonify({'status': "success", "type": "groups",
                        "count": len(data), "data": json.loads(dumps(data))})
    ...
    def persons():
        ...
        return jsonify({'status': "success", "count": len(data),
                        "type": "person", "data": json.loads(dumps(data))})
